...
def main():
    ...
    train.add_argument('--selector',default='ss',choices=('ss','symbolic','id3','full'))
    train.add_argument('--selection-dimension',type=int,default=2048)
    train.add_argument('--selection-seed',default='selection-evaluation-0')
    ...
    try:
        if a.command=='train':
            ...
            m=fit(data(a.component_pairs),data(a.temporal_pairs),data(a.lexicon),seed=a.seed,dimension=a.dimension,mode=a.mode,selector=a.selector,selection_dimension=a.selection_dimension,selection_seed=a.selection_seed)
