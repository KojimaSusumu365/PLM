...
root=Path(__file__).resolve().parents[1]/'outputs/PLM-L1-v0.10'
sys.path.insert(0,str(root))
from evaluation.integrity import sha,verify_freeze
freeze=verify_freeze()
for name in ('REPORT.md','verification/strict/VERIFICATION.json','verification/legacy/VERIFICATION.json','verification/REPEATABILITY.json','verification/PRESERVATION_CHECK.json','verification/READ_AMBIGUITY.json','verification/BENCHMARK.json'):
