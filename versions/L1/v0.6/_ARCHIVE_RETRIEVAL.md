# PLM-L1-v0.6：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-v0.6.zip)
- 原本ZIPのSHA-256：`63e8e31784def18d241cf7585a590dfaa636cfd3f76fccd7d67da58323169ce7`
- 保存した展開済みスナップショット：337ファイル、201,653,885 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-v0.6 --download --dest ../PLM-restored
```
