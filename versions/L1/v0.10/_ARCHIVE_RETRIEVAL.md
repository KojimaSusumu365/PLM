# PLM-L1-v0.10：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-v0.10.zip)
- 原本ZIPのSHA-256：`00f2265ab4c8af2d827e3da4320f0adeff0dca3d8271cac0ba3a53f1a18967d8`
- 保存した展開済みスナップショット：132ファイル、68,122,150 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-v0.10 --download --dest ../PLM-restored
```
