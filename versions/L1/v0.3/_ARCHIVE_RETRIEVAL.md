# PLM-L1-v0.3：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-v0.3.zip)
- 原本ZIPのSHA-256：`00665a299d1d3746124508049adbdefb44ca9ae09a6683a6392f90d8f6e6f955`
- 保存した展開済みスナップショット：143ファイル、50,254,908 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-v0.3 --download --dest ../PLM-restored
```
