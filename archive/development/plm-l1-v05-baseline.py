...
names = ("PLM-L1-v0.1", "PLM-L1-v0.2", "PLM-L1-v0.3", "PLM-L1-v0.4", "PLM-P1-v0.2", "PLM-S1-v0.2")
files = []
for name in names:
...
with (outputs / "PLM-L1-v0.5" / "verification" / "PRESERVED_BASELINE.json").open("x",encoding="utf-8") as stream:
