# PLM-L1-SS-multicode-v0.1：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-SS-multicode-v0.1.zip)
- 原本ZIPのSHA-256：`66f0876a6b143bda19545a12a7a33f505b3944f403f43e79f47ddafdb4164676`
- 保存した展開済みスナップショット：156ファイル、194,101,088 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-SS-multicode-v0.1 --download --dest ../PLM-restored
```
