# PLM-L1-SS-weighting-v0.1：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-SS-weighting-v0.1.zip)
- 原本ZIPのSHA-256：`74603cf710373c0cc34cba8f52f8db2ffb00352f5672483481778fc6e4306525`
- 保存した展開済みスナップショット：114ファイル、86,542,642 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-SS-weighting-v0.1 --download --dest ../PLM-restored
```
