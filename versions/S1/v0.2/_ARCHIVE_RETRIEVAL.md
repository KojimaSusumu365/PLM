# PLM-S1-v0.2：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-S1-v0.2.zip)
- 原本ZIPのSHA-256：`b9e2c610ad195ebcf411fb6479f5b90d2335ddaffa61be916a0952d5cceb3ee6`
- 保存した展開済みスナップショット：414ファイル、246,150,162 bytes。
...
```sh
python tools/restore_archive.py --version PLM-S1-v0.2 --download --dest ../PLM-restored
```
