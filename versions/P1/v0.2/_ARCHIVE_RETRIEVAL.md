# PLM-P1-v0.2：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-P1-v0.2.zip)
- 原本ZIPのSHA-256：`2d143150d24da46f71786bbb36e73d8979d20dedd1c1cb6e67671fe048553887`
- 保存した展開済みスナップショット：260ファイル、128,226,972 bytes。
...
```sh
python tools/restore_archive.py --version PLM-P1-v0.2 --download --dest ../PLM-restored
```
