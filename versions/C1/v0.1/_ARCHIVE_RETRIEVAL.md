# PLM-C1-v0.1：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-C1-v0.1.zip)
- 原本ZIPのSHA-256：`fa6d1cb2d5dafc139463c8e59bf2ec3942f0acc8b094c3c378e692a8b26b92b2`
- 保存した展開済みスナップショット：25ファイル、1,464,922 bytes。
...
```sh
python tools/restore_archive.py --version PLM-C1-v0.1 --download --dest ../PLM-restored
```
