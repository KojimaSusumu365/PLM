# PLM-C2-v0.4：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-C2-v0.4.zip)
- 原本ZIPのSHA-256：`d9b238c72e8bac897d67bc1f674d47576fb003288112b0ffabfb8b519e77797f`
- 保存した展開済みスナップショット：80ファイル、2,248,569 bytes。
...
```sh
python tools/restore_archive.py --version PLM-C2-v0.4 --download --dest ../PLM-restored
```
