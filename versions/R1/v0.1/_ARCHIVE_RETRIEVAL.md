# PLM-R1-v0.1：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-R1-v0.1.zip)
- 原本ZIPのSHA-256：`81b6eac5558dbed93813282a6a45c07bee29f6b9309de3da44dca709bced071f`
- 保存した展開済みスナップショット：117ファイル、3,878,047 bytes。
...
```sh
python tools/restore_archive.py --version PLM-R1-v0.1 --download --dest ../PLM-restored
```
