...
from plm_l1_v06.banked import BankedMemory,MemoryBlock
from plm_l1_v06.lexicon import ROLES,GOALS
...
class TemporalModel:
    def __init__(self,component,memories,training,*,dimension=8192,seed='temporal-development-0',mode='bound'):
        ...
        self.meta={'schema':'plm-temporal-model-v1','component_fingerprint':component.fingerprint,
    ...
    def encode(self,meaning):
        ...
        return {'schema':'plm-temporal-signal-v1','model_fingerprint':self.fingerprint,'dimension':self.codec.dimension,
    ...
    def recover(self,packet):
        try:
            ...
            require(packet['schema']=='plm-temporal-signal-v1' and packet['model_fingerprint']==self.fingerprint,'packet_model_mismatch')
