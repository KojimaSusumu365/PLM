# PLM-C2-v0.2：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-C2-v0.2.zip)
- 原本ZIPのSHA-256：`39369c55d24f4a0ced9b40afd53a69028de7a8670c79044932cc5cd008d0310f`
- 保存した展開済みスナップショット：49ファイル、4,813,948 bytes。
...
```sh
python tools/restore_archive.py --version PLM-C2-v0.2 --download --dest ../PLM-restored
```
