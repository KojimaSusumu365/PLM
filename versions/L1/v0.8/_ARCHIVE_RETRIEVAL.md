# PLM-L1-v0.8：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-v0.8.zip)
- 原本ZIPのSHA-256：`b672639e0e734230ffe1c4fef781aeafe10e4b68e9ba5ce9fc34b0c5646fd751`
- 保存した展開済みスナップショット：493ファイル、302,561,089 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-v0.8 --download --dest ../PLM-restored
```
