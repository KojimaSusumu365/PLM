# PLM-L1-v0.5：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-v0.5.zip)
- 原本ZIPのSHA-256：`9b653488396b2953b0d6e13be74896ff5b66c31aac18bcbef0c6705b14012670`
- 保存した展開済みスナップショット：268ファイル、143,214,277 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-v0.5 --download --dest ../PLM-restored
```
