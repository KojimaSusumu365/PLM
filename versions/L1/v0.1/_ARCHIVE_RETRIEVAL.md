# PLM-L1-v0.1：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-v0.1.zip)
- 原本ZIPのSHA-256：`3376c00ce78a6686db0a56112fc28afb3a53059545c7df73c4d6eb4d8edb32a3`
- 保存した展開済みスナップショット：35ファイル、7,937,796 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-v0.1 --download --dest ../PLM-restored
```
