# PLM-L1-SS-doc-v0.5：完全データの取得

このフォルダーは履歴を読みやすくするための閲覧用コピーです。原本のコード・文書は編集していませんが、1 MiBを超える結果や数値配列、元ZIP等はGitツリーの対象外です。

- [この版の原本ZIP](https://github.com/KojimaSusumu365/PLM/releases/download/archive-c0-v0.1-to-ss-core-v0.4/PLM-L1-SS-doc-v0.5.zip)
- 原本ZIPのSHA-256：`7848196c2a72b0903264dce3926afb21187d05d697766edd10ca7f0faf45e464`
- 保存した展開済みスナップショット：463ファイル、50,266,126 bytes。
...
```sh
python tools/restore_archive.py --version PLM-L1-SS-doc-v0.5 --download --dest ../PLM-restored
```
